...
Extra_intro1	BYTE		"** Program will Validate the second number to be less than the first.", 0
Extra_intro2	BYTE		"** Program will repeat until the user chooses to quit.", 0
Extra_intro3	BYTE		"** Program will calculate and shows quotient to the nearest .001.", 0
